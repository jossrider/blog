...
<g>
                ...
                <div id="tipo">
                    <h1><span itemporp="name">Dovosoft</span></h1> 
                    <h2><span itemprop="title">Deploying Ideas!</span></h2>
                </div>
                <nav>
                    <ul>
                        <li><a href="index.html"><canvas id="iconoInicio" height="50" width="50"></canvas><br/>Inicio</a></li>
                        <li><a href="noticias.html"><canvas id="iconoNoticias" height="50" width="50"></canvas><br/>Noticias</a></li>
                        <li><a href="acercade.html"><canvas id="iconoAcercaDeMi" height="50" width="50"></canvas><br/>Acerca de</a></li>
                        <li><a href="contacto.html"><canvas id="iconoContacto" height="50" width="50"></canvas><br/>Contacto</a></li>
                    </ul>
                </nav>
            </header>
            <div id="contenido">
                ...
                echo "<h3>El mensaje que enviaste es: </h3>";
                echo "<br>";
                echo $mensaje;
                echo "<br>";
                echo "<br>";
                ...
                // envio de mail
                $aquien = "jossrider@gmail.com";
                $asunto = "correo del blog";
...
//                }
            ...
            <footer>
                <h6>
                    <div class="vcard">
                        <div>
                            <span class="name">Joss Rider</span>-
                            <span class="locality">San Lorenzo</span>-
                            <span class="region">Central</span>-
                            <span class="postal-code">123250</span>-
                            <span class="country-name">Paraguay</span>-
                            <span class="tel">+595981172209</span>-
                            <span class="email">jossrider@gmail.com</span>                         
                        </div>
                    </div>
                </h6>
                ...
                <script type="text/javascript">
                    ...
                    document.write("En esta sesion has visitado la pagina :" + sessionStorage.pagecount + " veces");
                </script>
            </footer>
        </div>
    </body>
...
<script type="text/javascript">
    ...
    // iconoAcercaDeMi
    var c = document.getElementById("iconoAcercaDeMi");
